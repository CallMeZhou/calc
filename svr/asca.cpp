...
tuple<header_t, msgbuff_t> lambda_asca(const msgbuff_t &request, const args_t &args_url, const args_t &args_query, const args_t &args_header) {
    ...
    try {
        ...
        int requestedWidth = std::atoi(server_utils::find_arg(args_header, args_query, "requested-width", "80").c_str());
